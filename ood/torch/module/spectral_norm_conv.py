...
Modified the code for 3d convolutions (not sure)
"""
import torch
from torch.nn.functional import normalize, conv_transpose3d, conv3d
...
def spectral_norm_conv(
    ...
    Example::
        ...
        >>> m = spectral_norm_conv(nn.Conv3D(3, 16, 3), (3, 32, 32), 2.0)

    """

    input_dim_5d = torch.Size([1, input_dim[0], input_dim[1], input_dim[2], input_dim[3]])
    SpectralNormConv.apply(module, coeff, input_dim_5d, name, n_power_iterations, eps)
