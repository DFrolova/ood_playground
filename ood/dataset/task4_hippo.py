...
class Task4Hippo(MultichannelSegmentationFromCSV):
    def __init__(self, data_path, modalities=('MRI', ), target='hippo_mask', metadata_rpath='meta_filtered.csv', index_col='id'):
